...
function Aside() {
  ...
  {
        setHamburgerIcon(prevIcon => prevIcon === "expand_more" ? "expand_less" : "expand_more");
  ...
  return (
    <aside className={`aside ${toggleBeautfiyAside}`} id="aside">
      ...
      <button className="aside-hamburger" id="aside-hamburger" onClick={() => hamburgerMenuClickHandler()}>
